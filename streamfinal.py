...
def main():
    try:
        ...
        # Add a background image using a local image or URL
        st.markdown(
            """
            <style>
            .stApp {
        ...
        # Header and description with custom font
        #st.markdown("<h1 style='text-align: center; color: #4CAF50;'>SpeechVerse</h1>", unsafe_allow_html=True)
        #st.write("Please speak in English, and it will be translated into the selected language.")
        ...
        st.markdown("<p style='text-align: center; color: #2C3E50;'>Select a target language (French, Spanish, or Hindi).</p>", unsafe_allow_html=True)
        # Add instructions with a playful tone
        #st.markdown("""
        #<div style="text-align: center; font-size: 18px; color: #333;">
        #    <strong>Instructions:</strong> 
        #    <ul>
        #        <li>Select a target language (French, Spanish, or Hindi).</li>
        #        <li>Click on "Start Translation" to begin.</li>
        #        <li>Speak in English for translation to the chosen language.</li>
        #    </ul>
        #</div>
        #""", unsafe_allow_html=True)
