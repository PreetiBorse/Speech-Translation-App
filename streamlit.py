...
def main():
    try:
        ...
        st.set_page_config(page_title="Speech Translation App", page_icon="🎤")

        # Add a background color using linear gradient
        # Header and subheading with custom font
        st.markdown("<h1 style='text-align: center; color: #2C3E50;'>Speech Translation App</h1>", unsafe_allow_html=True)
        ...
        targetLanguage = st.selectbox("Select target language", ["French", "Spanish", "Hindi"])
